...
class CacheServiceProvider extends ServiceProvider
{
    ...
    private function defineCacheTimeConstants(): void
    {
        ...
        */
        ...
        define('CACHE_TIME_PROJECT_TAGS_DATA', 3 * $hour);
    }
    ...
    private function defineCacheKeysConstants(): void
    {
        ...
        */
        ...
        define('CACHE_KEY_TEAM_LINKS_DATA', 'team_links_data:'); // :teamId:true/false - isMember
        define('CACHE_KEY_TEAM_TAGS_DATA', 'team_tags_data:');
        define('CACHE_KEY_TEAM_VACANCIES_DATA', 'team_vacancies_data:');

        define('CACHE_KEY_TEAM_USER_MODERATOR', 'team_user_moderator_data:'); // :teamId:userId

        define('CACHE_KEY_VACANCY_DATA', 'vacancy_data:');
        ...
        define('CACHE_KEY_PROJECT_TAGS_DATA', 'project_tags_data:');
    }
}
